...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget_2->setGeometry(QRect(0, 840, 511, 111));
        ...
        lineEdit_xc2el = new QLineEdit(layoutWidget_2);
        ...
        lineEdit_yc2el = new QLineEdit(layoutWidget_2);
        ...
        lineEdit_abeg = new QLineEdit(layoutWidget_2);
        ...
        lineEdit_bbeg = new QLineEdit(layoutWidget_2);
        ...
        lineEdit_nel = new QLineEdit(layoutWidget_2);
        lineEdit_nel->setObjectName(QStringLiteral("lineEdit_nel"));

        horizontalLayout_5->addWidget(lineEdit_nel);


        verticalLayout_6->addLayout(horizontalLayout_5);

        pushButton_drawmanyel = new QPushButton(layoutWidget_2);
        pushButton_drawmanyel->setObjectName(QStringLiteral("pushButton_drawmanyel"));
        pushButton_drawmanyel->setFont(font);

        verticalLayout_6->addWidget(pushButton_drawmanyel);
        ...
        graphicsView->setGeometry(QRect(600, 50, 710, 710));
        widget = new QWidget(centralWidget);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(0, 10, 341, 381));
        ...
        LinesColourcomboBox = new QComboBox(widget);
        ...
        BackgroundColourcomboBox = new QComboBox(widget);
        ...
        radioButton_kan = new QRadioButton(widget);
        ...
        radioButton_par = new QRadioButton(widget);
        ...
        radioButton_br = new QRadioButton(widget);
        ...
        radioButton_srt = new QRadioButton(widget);
        ...
        radioButton_dll = new QRadioButton(widget);
        ...
        widget1->setGeometry(QRect(0, 410, 391, 81));
        ...
        lineEdit_xc1cir = new QLineEdit(widget1);
        ...
        lineEdit_yc1cir = new QLineEdit(widget1);
        ...
        pushButton_drawonecir = new QPushButton(widget1);
        ...
        widget2->setGeometry(QRect(0, 520, 501, 111));
        ...
        lineEdit_xc2cir = new QLineEdit(widget2);
        ...
        lineEdit_yc2cir = new QLineEdit(widget2);
        ...
        lineEdit_rbeg = new QLineEdit(widget2);
        ...
        lineEdit_rend = new QLineEdit(widget2);
        ...
        lineEdit_ncir = new QLineEdit(widget2);
        lineEdit_ncir->setObjectName(QStringLiteral("lineEdit_ncir"));

        horizontalLayout_2->addWidget(lineEdit_ncir);


        verticalLayout_3->addLayout(horizontalLayout_2);

        pushButton_drawmanycir = new QPushButton(widget2);
        ...
        widget3->setGeometry(QRect(10, 670, 471, 141));
        ...
        lineEdit_xcel = new QLineEdit(widget3);
        ...
        lineEdit_ycel = new QLineEdit(widget3);
        ...
        lineEdit_a = new QLineEdit(widget3);
        ...
        lineEdit_b = new QLineEdit(widget3);
        ...
        pushButton_drawoneel = new QPushButton(widget3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_9->setText(QApplication::translate("MainWindow", "\320\232\320\276\320\273-\320\262\320\276:", nullptr));
